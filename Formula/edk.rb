class Edk < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/envdock-spec/edk/releases/download/v1.1.1/envdock-cli-macos-arm64"
    sha256 "1b77c26bb417d80cf807e67b5f11667760b474b83cb9d06a48c891d37b95aea2"
  elsif OS.mac?
    url "https://github.com/envdock-spec/edk/releases/download/v1.1.1/envdock-cli-macos-x64"
    sha256 "c5c4a3ae65cc59d22216d3e8e30385c2bb09b259869f07f49690905a89a5406f"
  elsif OS.linux?
    url "https://github.com/envdock-spec/edk/releases/download/v1.1.1/envdock-cli-linux-x64"
